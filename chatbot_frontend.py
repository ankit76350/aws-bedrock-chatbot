# run this to run the code: /opt/anaconda3/bin/python -m streamlit run chatbot_frontend.py
...
st.title("Hi, This is Chatbot Ankit :sunglasses:") # **Modify this based on the title you want in want
...
input_text = st.chat_input("Chat with Ankit") # **display a chat input box
if input_text: 
